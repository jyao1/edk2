  ...
  )
{
  ...
  return SpdmSendReceiveData (SpdmContext, Request, RequestSize, Response, ResponseSize);
}
...
EFI_STATUS
EFIAPI
SpdmProtocolSendReceiveSessionData (
  IN     SPDM_PROTOCOL  *This,
  IN     UINT32               SessionId,
  IN     VOID                 *Request,
  IN     UINTN                RequestSize,
  ...
  )
{
  ...
  return SpdmSendReceiveSessionData (SpdmContext, SessionId, Request, RequestSize, Response, ResponseSize);
}
