...
#ifndef __SPDM_TEST_PPI_H__
#define __SPDM_TEST_PPI_H__

#include <Base.h>
#include <IndustryStandard/Spdm.h>
#include <Ppi/Spdm.h>

typedef struct _SPDM_TEST_PPI SPDM_TEST_PPI;
